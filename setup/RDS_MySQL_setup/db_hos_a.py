...
# For hos-a
cursor.execute("""CREATE DATABASE hos_a;""")

# 1. Departments Table:
departments_query = """
CREATE TABLE hos_a.departments (
...
transactions_query = """
CREATE TABLE hos_a.transactions (
